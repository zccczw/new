...
def get_parser():
    ...
    parser.add_argument("--epochs", type=int, default="10")#1
    parser.add_argument("--bs", type=int, default=128)#1
    parser.add_argument("--init_lr", type=float, default=0.001)#1
    parser.add_argument("--dropout", type=float, default=0.4)#1
    ...
    parser.add_argument("--recon_hid_dim", type=int, default=100)#150
    # Other
